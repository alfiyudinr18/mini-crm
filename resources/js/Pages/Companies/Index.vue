    ...
    <AuthenticatedLayout>
        <div class="min-h-screen bg-gray-50 py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        >
                            ...
                            <template #item-action="{ action }">
                                <div class="flex space-x-2">
                                    <Link
                                        :href="route('companies.edit', action)"
                                    ...
                                    <Link
                                        ...
                                        method="delete"
                                        :href="
                                            route('companies.destroy', action)
                                        "
                ...
                <div v-if="companies.total > companies.per_page" class="mt-6">
                    <div
                        class="bg-white px-4 py-3 rounded-lg shadow-sm border border-gray-200"
                    >
                        <div class="text-sm text-gray-700 text-center">
                            Showing {{ companies.from }} to
                            {{ companies.to }} of {{ companies.total }} results
                        </div>
                    </div>
                </div>
            </div>
